...
import { skillCategories as defaultSkillCategories } from '../../data/skills.tsx'; 
...
const SkillsSection: React.FC<SkillsSectionProps> = ({ skillData = defaultSkillCategories }) => {
  const [ref, isVisible] = useScrollAnimation<HTMLDivElement>({ threshold: 0.1, triggerOnce: true });

  return (
    <section id="skills" ref={ref} className="py-20 bg-gray-50 dark:bg-slate-800 text-text-light dark:text-text-dark">
